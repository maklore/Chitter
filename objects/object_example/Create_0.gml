...
And using [particles : true, part_id : 0, part_fade_out : 1, part_fade_spd : 0.01, part_colour2 : true, part_colour2_1 : #FFFFFF, part_colour2_2 : #000000, part_life : true, part_life_min : 2, part_life_max : 15, part_direction : true, part_direction_min : 80, part_direction_max : 100, part_direction_increase : 1, part_speed : true, part_speed_min : 1, part_speed_max : 1]particles[] is heavy...

Please check the readme at:
[color : #00ffff]https://github.com/maklore/Chitter/[]
