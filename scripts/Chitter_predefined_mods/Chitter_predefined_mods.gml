...
function __chitter_premods() constructor {
	...
	part_insane = "color_random : true, color_random_red : 150, color_random_blue : 0, color_random_green : 0, particles : true, part_life : true, part_life_min : 2, part_life_max : 5, part_direction : true, part_direction_min : 0, part_direction_max : 360, part_direction_increase : 1, part_speed : true, part_speed_min : 2, part_speed_max : 3";
	part_burned = "particles : true, part_fade_out : 1, part_fade_speed : 0.01, part_colour3 : true, part_colour3_1 : #FFFFFF, part_colour3_2 : #0F0F00, part_colour3_3 : #FF0000, part_life : true, part_life_min : 2, part_life_max : 15, part_direction : true, part_direction_min : 80, part_direction_max : 100, part_direction_increase : 1, part_speed : true, part_speed_min : 1, part_speed_max : 2"
}