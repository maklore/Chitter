...
function __chitter_premods() constructor {
	...
	slow_wave	 = "wave_y : true, wave_amp : 20, wave_frq : 10000, particles : true, particles_id : 101, particles_life : true, particles_life_min : 2, particles_life_max : 5, particles_direction : true, particles_direction_min : 0, particles_direction_max : 360, particles_direction_increase : 1, particles_speed : true, particles_speed_min : 1, particles_speed_max : 2";
