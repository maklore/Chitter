...
function __chitter_premods() constructor {
	...
	part_burning = "particles : true, part_id : 12, part_colour3 : true, part_colour3_1 : #FFFFFF, part_colour3_2 : #0F0F00, part_colour3_3 : #FF0000, part_life : true, part_life_min : 2, part_life_max : 15, part_direction : true, part_direction_min : 80, part_direction_max : 100, part_direction_increase : 1, part_speed : true, part_speed_min : 1, part_speed_max : 2"
}