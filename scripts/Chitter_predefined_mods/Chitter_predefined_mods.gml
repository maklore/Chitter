...
function __chitter_premods() constructor {
	...
	part_burned_white = "alpha : 0, particles : true, part_fade_out : 1, part_fade_speed : 0.01, part_colour3 : true, part_colour3_1 : #FFFFFF, part_colour3_2 : #0F0F00, part_colour3_3 : #FF0000, part_life : true, part_life_min : 2, part_life_max : 15, part_direction : true, part_direction_min : 80, part_direction_max : 100, part_direction_increase : 1, part_speed : true, part_speed_min : 1, part_speed_max : 2";
	part_burn_black_small = "alpha : 0.5, particles : true, part_colour3 : true, part_colour3_1 : #000000, part_colour3_2 : #FF0500, part_colour3_3 : #FFFFFF, part_life : true, part_life_min : 1, part_life_max : 15, part_direction : true, part_direction_min : 80, part_direction_max : 100, part_direction_increase : 1, part_speed : true, part_speed_min : 0, part_speed_max : 1";
	part_burnt = "colour : #000000, particles : true, part_fade_out : 1, part_fade_speed : 0.01, part_colour3 : true, part_colour3_1 : #FFFFFF, part_colour3_2 : #0F0F00, part_colour3_3 : #FF0000, part_life : true, part_life_min : 2, part_life_max : 15, part_direction : true, part_direction_min : 80, part_direction_max : 100, part_direction_increase : 1, part_speed : true, part_speed_min : 2, part_speed_max : 4";
}